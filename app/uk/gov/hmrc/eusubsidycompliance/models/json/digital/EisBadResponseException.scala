...
class EisBadResponseException(
  ...
  val code: EisParamValue = params.getOrElse(EisParamName.ERRORCODE, EisParamValue.unsafe("UNKNOWN"))
  val message: EisParamValue = params.getOrElse(EisParamName.ERRORTEXT, EisParamValue.unsafe("UNKNOWN"))
